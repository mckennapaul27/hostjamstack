...
const variants = {
  primary: clsx(
    ...
    'cursor-pointer data-disabled:bg-gray-950 data-disabled:opacity-40 data-hover:bg-gray-800',
  ),
  secondary: clsx(
    ...
    'cursor-pointer data-disabled:bg-white/15 data-disabled:opacity-40 data-hover:bg-white/20',
  ),
  outline: clsx(
    ...
    'cursor-pointer data-disabled:bg-transparent data-disabled:opacity-40 data-hover:bg-gray-50',
  ),
}
